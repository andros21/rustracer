...
impl ScatterRay for DiffuseBRDF {
    /// Random scattering on semi-sphere using two [`f32`] that will be generated by
    /// [`Pcg`](../../../random/struct.Pcg.html) random generator.
    fn scatter_ray(
        &self,
        pcg: (f32, f32),
